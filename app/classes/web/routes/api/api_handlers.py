...
from app.classes.web.routes.api.auth.register import ApiAuthRegisterHandler
...
from app.classes.web.routes.api.servers.server.mods import (
    ApiServersServerModsSearchHandler,
    ApiServersServerModsInstallHandler,
    ApiServersServerModsProjectHandler,
)
...
def api_handlers(handler_args):
    return [
        ...
        (
            r"/api/v2/auth/register/?",
            ApiAuthRegisterHandler,
            handler_args,
        ),
        (
        ...
        (
            r"/api/v2/servers/([a-z0-9-]+)/mods/search/?",
            ApiServersServerModsSearchHandler,
            handler_args,
        ),
        (
            r"/api/v2/servers/([a-z0-9-]+)/mods/install/?",
            ApiServersServerModsInstallHandler,
            handler_args,
        ),
        (
            r"/api/v2/servers/([a-z0-9-]+)/mods/project/([^/]+)/?",
            ApiServersServerModsProjectHandler,
            handler_args,
        ),
        (
